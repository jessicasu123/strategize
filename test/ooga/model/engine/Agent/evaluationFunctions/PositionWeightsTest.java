...
public class PositionWeightsTest {
    ...
    void testWeightsWithCornerStableAndDangerZoneConsiderations() {
        ...
        List<List<Integer>> othelloWeights = new ArrayList<>(List.of(weights_row1,weights_row2,weights_row3,weights_row4,
    ...
    List<List<Integer>> checkersWeights = new ArrayList<>(List.of(weights_row1,weights_row2,weights_row3,weights_row4));
