...
class AgentPlayerTest {
    ...
    private AgentPlayer myTicTacToeAgentPlayer = new AgentPlayer(agent, new TicTacToeAgent(1,2,3),user, 1);
    ...
    void calculateMoveEmptyBoard() throws InvalidMoveException {
        ...
        BoardFramework myBoard = new Board(new TicTacToeFactory(user,agent), sampleConfig, new ArrayList<>(List.of("horizontal")));
