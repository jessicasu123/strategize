...
class NoMovesMorePiecesTest {
    ...
    NoMovesMorePieces mancalaWinType = new NoMovesMorePieces(1, new Grid(initialConfig), false, 0);

    List<Integer> othelloPlayer1States = new ArrayList<>(List.of(1));
    List<Integer> othelloPlayer2States = new ArrayList<>(List.of(2));

    NoMovesMorePieces othelloWinType = new NoMovesMorePieces(0, new Grid(initialConfig), true, 0);
    ...
    void testMancalaGameInProgress() {
        ...
        assertFalse(mancalaWinType.isWin(mancalaPlayer1States, new Grid(boardForGameInProgress),new Grid(boardForGameInProgress), false));
    }
    ...
    void testMancalaPlayer1Win() {
        ...
        assertTrue(mancalaWinType.isWin(mancalaPlayer1States, new Grid(boardForUserWin),new Grid(boardForUserWin), true));
        assertFalse(mancalaWinType.isWin(mancalaPlayer2States, new Grid(boardForUserWin),new Grid(boardForUserWin), true));
    }
    ...
    void testMancalaPlayer2Win() {
        ...
        assertFalse(mancalaWinType.isWin(mancalaPlayer1States, new Grid(boardForUserLose),new Grid(boardForUserLose), true));
        assertTrue(mancalaWinType.isWin(mancalaPlayer2States, new Grid(boardForUserLose),new Grid(boardForUserLose), true));
    }
    ...
    void testMancalaTie() {
        ...
        assertFalse(mancalaWinType.isWin(mancalaPlayer1States, new Grid(boardForTie),new Grid(boardForTie), true)
                && mancalaWinType.isWin(mancalaPlayer2States, new Grid(boardForTie),new Grid(boardForTie), true));
    }
    ...
    void testOthelloNoWin() {
        ...
        assertFalse(othelloWinType.isWin(othelloPlayer2States, new Grid(boardConfig),new Grid(boardConfig), false));
        assertFalse(othelloWinType.isWin(othelloPlayer1States, new Grid(boardConfig),new Grid(boardConfig), false));
    }
    ...
    void testOthelloPlayer1Win() {
        ...
        List<List<Integer>> boardConfig = new ArrayList<>(List.of(row1,row2,row3,row4));
        assertTrue(othelloWinType.isWin(othelloPlayer1States, new Grid(boardConfig),new Grid(boardConfig), true));
        assertFalse(othelloWinType.isWin(othelloPlayer2States, new Grid(boardConfig),new Grid(boardConfig), true));
    }
    ...
    void testOthelloPlayer2Win() {
        ...
        List<List<Integer>> boardConfig = new ArrayList<>(List.of(row1,row2,row3,row4));
        assertFalse(othelloWinType.isWin(othelloPlayer1States, new Grid(boardConfig),new Grid(boardConfig), true));
        assertTrue(othelloWinType.isWin(othelloPlayer2States, new Grid(boardConfig),new Grid(boardConfig), true));
    }
