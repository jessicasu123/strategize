...
public class MorePiecesTest {
    ...
    void testMorePiecesOthello() {
        ...
        BoardConfiguration initialConfig = new BoardConfiguration(new ArrayList<>(List.of(initial_row1,initial_row2,initial_row3,initial_row4,
    ...
    void testMorePiecesMancala() {
        ...
        BoardConfiguration initialConfig = new BoardConfiguration(new ArrayList<>(List.of(initial_row1,initial_row2)));
        ...
        BoardConfiguration boardConfig = new BoardConfiguration(new ArrayList<>(List.of(row1,row2)));
