...
import ooga.model.engine.pieces.moveChecks.JumpCheck;
import ooga.model.engine.pieces.moveChecks.OwnPieceCheck;
import ooga.model.engine.pieces.moveChecks.StepCheck;
...
public class CheckersIntegrationTest {
    ...
    MoveType promotionPlayer1 = new PromotionMove(4,2);
    MoveType promotionPlayer2 = new PromotionMove(0,4);
