...
class OpponentPieceCheckTest {
    ...
    OpponentPieceCheck player1OpponentCheck = new OpponentPieceCheck(emptyState, player1States);
    OpponentPieceCheck player2OpponentCheck = new OpponentPieceCheck(emptyState, player2States);
