...
class SpecialCaptureMoveTest {
    ...
    SpecialCaptureMove capture1 = new SpecialCaptureMove(player,finder1);
    SpecialCaptureMove capture2 = new SpecialCaptureMove(player2,finder2);
