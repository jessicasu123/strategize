...
class FindNeighborsBetweenCoordinatesTest {
    ...
    GamePiece piece00 = new GamePiece(0,coord00,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord11 = new Coordinate(1,1);
    GamePiece piece11 = new GamePiece(0,coord11,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord22 = new Coordinate(2,2);
    GamePiece piece22 = new GamePiece(0,coord22,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord33 = new Coordinate(3,3);
    GamePiece piece33 = new GamePiece(0,coord33,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord44 = new Coordinate(4,4);
    GamePiece piece44 = new GamePiece(0,coord44,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord55 = new Coordinate(5,5);
    GamePiece piece55 = new GamePiece(0,coord55,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord50 = new Coordinate(5,0);
    GamePiece piece50 = new GamePiece(0,coord50,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord41 = new Coordinate(4,1);
    GamePiece piece41 = new GamePiece(0,coord41,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord32 = new Coordinate(3,2);
    GamePiece piece32 = new GamePiece(0,coord32,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord23 = new Coordinate(2,3);
    GamePiece piece23 = new GamePiece(0,coord23,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord14 = new Coordinate(1,4);
    GamePiece piece14 = new GamePiece(0,coord14,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord05 = new Coordinate(0,5);
    GamePiece piece05 = new GamePiece(0,coord05,direction,1,new ArrayList<>(), new ArrayList<>());

    //a few random other squares
    Coordinate coord31 = new Coordinate(3,1);
    GamePiece piece31 = new GamePiece(0,coord31,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord43 = new Coordinate(4,3);
    GamePiece piece43 = new GamePiece(0,coord43,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord21 = new Coordinate(2,1);
    GamePiece piece21 = new GamePiece(0,coord21,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord10 = new Coordinate(1,0);
    GamePiece piece10 = new GamePiece(0,coord10,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord12 = new Coordinate(1,2);
    GamePiece piece12 = new GamePiece(0,coord12,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord45 = new Coordinate(4,5);
    GamePiece piece45 = new GamePiece(0,coord45,direction,1,new ArrayList<>(), new ArrayList<>());
    Coordinate coord54 = new Coordinate(5,4);
    GamePiece piece54 = new GamePiece(0,coord54,direction,1,new ArrayList<>(), new ArrayList<>());
