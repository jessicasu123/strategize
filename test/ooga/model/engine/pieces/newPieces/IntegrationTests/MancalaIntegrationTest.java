...
public class MancalaIntegrationTest {
    ...
    ConvertableNeighborFinder player1Finder = new FindNeighborsUntilNoObjects(player1StatesToIgnore);
    ConvertableNeighborFinder player2Finder = new FindNeighborsUntilNoObjects(player2StatesToIgnore);
