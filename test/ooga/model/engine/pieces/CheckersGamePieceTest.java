...
class CheckersGamePieceTest {
    ...
    CheckersGamePiece checker1Red = new CheckersGamePiece(1,1,2,1, pos1);
    CheckersGamePiece checker1Black = new CheckersGamePiece(3,3,4,-1, pos1);
    CheckersGamePiece checker1Empty = new CheckersGamePiece(0,0,0,0, pos1);

    Coordinate pos2 = new Coordinate(1,1);
    CheckersGamePiece checker2Red = new CheckersGamePiece(1,1,2,1, pos2);
    CheckersGamePiece checker2Black = new CheckersGamePiece(3,3,4,-1, pos2);
    CheckersGamePiece checker2Empty = new CheckersGamePiece(0,0,0,0, pos2);

    Coordinate pos3 = new Coordinate(2,2);
    CheckersGamePiece checker3Red = new CheckersGamePiece(1,1,2,1, pos3);
    CheckersGamePiece checker3Black = new CheckersGamePiece(3,3,4,-1, pos3);
    CheckersGamePiece checker3Empty = new CheckersGamePiece(0,0,0,0, pos3);

    Coordinate pos4 = new Coordinate(3,3);
    CheckersGamePiece checker4Red = new CheckersGamePiece(1,1,2,1, pos4);
    CheckersGamePiece checker4Black = new CheckersGamePiece(3,3,4,-1, pos4);
    CheckersGamePiece checker4Empty = new CheckersGamePiece(0,0,0,0, pos4);

    Coordinate pos5 = new Coordinate(4,4);
    CheckersGamePiece checker5Red = new CheckersGamePiece(1,1,2,1, pos5);
    CheckersGamePiece checker5Black = new CheckersGamePiece(3,3,4,-1, pos5);
    CheckersGamePiece checker5Empty = new CheckersGamePiece(0,0,0,0, pos5);

    //alternate diagonals
    Coordinate pos6 = new Coordinate(2,0);
    CheckersGamePiece checker6Red = new CheckersGamePiece(1,1,2,1, pos6);
    CheckersGamePiece checker6Black = new CheckersGamePiece(3,3,4,-1, pos6);
    CheckersGamePiece checker6Empty = new CheckersGamePiece(0,0,0,0, pos6);

    Coordinate pos7 = new Coordinate(3,1);
    CheckersGamePiece checker7Red = new CheckersGamePiece(1,1,2,1, pos7);
    CheckersGamePiece checker7Black = new CheckersGamePiece(3,3,4,-1, pos7);
    CheckersGamePiece checker7Empty = new CheckersGamePiece(0,0,0,0, pos7);

    Coordinate pos8 = new Coordinate(4,0);
    CheckersGamePiece checker8Red = new CheckersGamePiece(1,1,2,1, pos8);
    CheckersGamePiece checker8Black = new CheckersGamePiece(3,3,4,-1, pos8);
    CheckersGamePiece checker8Empty = new CheckersGamePiece(0,0,0,0, pos8);

    Coordinate pos9 = new Coordinate(4,2);
    CheckersGamePiece checker9Red = new CheckersGamePiece(1,1,2,1, pos9);
    CheckersGamePiece checker9Black = new CheckersGamePiece(3,3,4,-1, pos9);
    CheckersGamePiece checker9Empty = new CheckersGamePiece(0,0,0,0, pos9);

    Coordinate pos10 = new Coordinate(3,1);
    CheckersGamePiece checker10Red = new CheckersGamePiece(1,1,2,1, pos10);
    CheckersGamePiece checker10Black = new CheckersGamePiece(3,3,4,-1, pos10);
    CheckersGamePiece checker10Empty = new CheckersGamePiece(0,0,0,0, pos10);

    Coordinate pos11 = new Coordinate(2,4);
    CheckersGamePiece checker11Red = new CheckersGamePiece(1,1,2,1, pos11);
    CheckersGamePiece checker11Black = new CheckersGamePiece(3,3,4,-1, pos11);
    CheckersGamePiece checker11Empty = new CheckersGamePiece(0,0,0,0, pos11);

    Coordinate pos12 = new Coordinate(1,3);
    CheckersGamePiece checker12Red = new CheckersGamePiece(1,1,2,1, pos12);
    CheckersGamePiece checker12Black = new CheckersGamePiece(3,3,4,-1, pos12);
    CheckersGamePiece checker12Empty = new CheckersGamePiece(0,0,0,0, pos12);

    Coordinate pos13 = new Coordinate(0,4);
    CheckersGamePiece checker13Red = new CheckersGamePiece(1,1,2,1, pos13);
    CheckersGamePiece checker13Black = new CheckersGamePiece(3,3,4,-1, pos13);
    CheckersGamePiece checker13Empty = new CheckersGamePiece(0,0,0,0, pos13);

    CheckersGamePiece king =  new CheckersGamePiece(2,1,2,1,new Coordinate(2,2));
    CheckersGamePiece king2 =  new CheckersGamePiece(2,1,2,1,new Coordinate(0,0));
    CheckersGamePiece king3 =  new CheckersGamePiece(4,3,4,-1,new Coordinate(2,2));
    CheckersGamePiece king4 =  new CheckersGamePiece(4,3,4,-1,new Coordinate(0,0));
    ...
    void testMakeMoveRed() {
        ...
        checker1Red = new CheckersGamePiece(1,1,2,1, pos1);
        checker2Empty = new CheckersGamePiece(0,0,0,0, pos2);
        ...
        checker1Red = new CheckersGamePiece(1,1,2,1, pos1);
        checker2Black = new CheckersGamePiece(3,3,4,-1, pos2);
        checker3Empty = new CheckersGamePiece(0,0,0,0, pos3);
    ...
    void testMakeMoveBlack() {
        ...
        checker5Black = new CheckersGamePiece(3,3,4,-1, pos5);
        checker4Empty = new CheckersGamePiece(0,0,0,0, pos4);
        ...
        checker5Black = new CheckersGamePiece(3,3,4,-1, pos5);
        checker4Red = new CheckersGamePiece(1,1,2,1, pos4);
        checker3Empty = new CheckersGamePiece(0,0,0,0, pos3);
