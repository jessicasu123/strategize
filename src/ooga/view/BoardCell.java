...
public abstract class BoardCell {
     ...
     */
    protected double getCellWidth() {return myCellWidth; }

    /**
     * @return height of the cell
     */
    protected double getCellHeight() {return myCellHeight;}
     ...
     */
    protected abstract Node createCell();
     ...
     */
    protected abstract void updateImageOnSquare(Image image);

    /**
     * Updates the background color of the cell.
     * @param color - the color to set the cell to
     */
    protected abstract void updateCellFill(String color);

    /**
     * Clears the current cell fill.
     * @param color
     */
    protected abstract void clearFill(String color);
     ...
     */
    protected abstract void setStyle(String boardColor, String boardOutline);
