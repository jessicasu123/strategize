...
// * in the view.
// */
//public class GameEndPopUp extends GamePopUp{
...
//
//    public GameEndPopUp(Stage stage, int width, int height, String endStatus) {
...
//        labelText = gameEndScreenData.getJSONObject("Labels");
...
//        Image messageImg = new Image(gameEndScreenData.getJSONObject("Images").getString(winStatus+"Image"));
...
//        buttonText = gameEndScreenData.getJSONObject("Buttons");
